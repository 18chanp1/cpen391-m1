...
/**
 * A function that converts a single digit to its corresponding
 * representation on the 7 segment display and returns the encoding
 * 
 * input - digit to convert.
*/
int convert_to_7seg(int input);

/**
 * A helper function that displays number onto the lower 3 segment
 * displays if lo is 1, and upper 3 segments if lo is 0.
 * 
 * number - number to display
 * lo - lower 3 7seg or upper 3 7seg
*/
int display_7seg(int lo, int number);

/**
 * A function that displays a number on the 7-segment display.
 * number - number to display
*/
void display_7seg_all(int number);

/**
 * reads the position of the switches on the DE1 to determine
 * the multiplier for the light interval
*/
int read_timer_interval(void);

/**
 * Finds primes and displays them on the 7-segment displays
*/
void find_primes(void);

/**
 * An initializition routine to configure and enable interrupts
*/
void init_timer_interrupt(void);

/*
 * A function to change the timer's period / duration.
 * 
